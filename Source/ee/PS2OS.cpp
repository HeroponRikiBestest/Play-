...
#define BIOS_ADDRESS_IDLE_THREAD_ID (0x00000010 + BIOS_ADDRESS_STATE_BASE)
#define BIOS_ADDRESS_CURRENT_THREAD_ID (0x00000014 + BIOS_ADDRESS_STATE_BASE)
#define BIOS_ADDRESS_VSYNCFLAG_VALUE1PTR (0x00000018 + BIOS_ADDRESS_STATE_BASE)
#define BIOS_ADDRESS_VSYNCFLAG_VALUE2PTR (0x0000001C + BIOS_ADDRESS_STATE_BASE)
#define BIOS_ADDRESS_THREADSCHEDULE_BASE (0x00000020 + BIOS_ADDRESS_STATE_BASE)
#define BIOS_ADDRESS_INTCHANDLERQUEUE_BASE (0x00000024 + BIOS_ADDRESS_STATE_BASE)
#define BIOS_ADDRESS_DMACHANDLERQUEUE_BASE (0x00000028 + BIOS_ADDRESS_STATE_BASE)
#define BIOS_ADDRESS_TLB_READEXCEPTION_HANDLER (0x0000002C + BIOS_ADDRESS_STATE_BASE)
#define BIOS_ADDRESS_TLB_WRITEEXCEPTION_HANDLER (0x00000030 + BIOS_ADDRESS_STATE_BASE)
#define BIOS_ADDRESS_TRAPEXCEPTION_HANDLER (0x00000034 + BIOS_ADDRESS_STATE_BASE)
#define BIOS_ADDRESS_SIFDMA_NEXT_INDEX (0x00000038 + BIOS_ADDRESS_STATE_BASE)
#define BIOS_ADDRESS_SIFDMA_TIMES_BASE (0x0000003C + BIOS_ADDRESS_STATE_BASE)
